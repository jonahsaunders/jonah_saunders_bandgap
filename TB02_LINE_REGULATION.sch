...
F {}
E {}
T {TB02_LINE_REGULATION: DC line regulation} 220 50 0 0 0.5 0.5 {}
T {Line regulation: all 135 model combinations, 3 temperatures (405 sweeps).} 220 90 0 0 0.27 0.27 {}
...
C {vsource.sym} 900 240 0 0 {name=VDD value="DC \{VDD_RUN\}" savecurrent=false}
...
set noaskquit
echo BANDGAP_SINGLE_RUNNER_V9_TB02_LINE_REGULATION
shell python3 \"/foss/designs/chipalooza-bandgap/Jonah_Saunders_Bandgap/run_bandgap.py\" --deck \"/headless/.xschem/simulations/TB02_LINE_REGULATION.spice\" --test TB02_LINE_REGULATION
