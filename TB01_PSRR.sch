...
F {}
E {}
T {TB01_PSRR: PSRR} 220 50 0 0 0.5 0.5 {}
T {PSRR: all 135 model combinations, 3 temperatures, 7 supplies (2835 cases).} 220 90 0 0 0.27 0.27 {}
...
C {vsource.sym} 900 240 0 0 {name=VDD value="DC \{VDD_RUN\} AC 1" savecurrent=false}
...
set noaskquit
echo BANDGAP_SINGLE_RUNNER_V9_TB01_PSRR
shell python3 \"/foss/designs/chipalooza-bandgap/Jonah_Saunders_Bandgap/run_bandgap.py\" --deck \"/headless/.xschem/simulations/TB01_PSRR.spice\" --test TB01_PSRR
