...
F {}
E {}
T {TB05_LOOP_STABILITY: Integrated loop stability} 220 -40 0 0 0.5 0.5 {}
T {First run: typical process, 25 C, 5 V; two conditional loop cuts.} 220 0 0 0 0.27 0.27 {}
T {DUT: Bandgap_Core_LoopProbe. MAIN: vgn2 to M3 gate. BIAS: vbn_i to N2 gate.
Output bank and OTA capacitor are already inside the core; no extra load added.} 220 30 0 0 0.27 0.27 {}
...
T {MAIN loop probe: VLG e to f; ILG ground to e.
AC-only test sources. Both are zero at DC.} 1040 340 0 0 0.23 0.23 {}
T {BIAS loop probe: VLG e to f; ILG ground to e.
AC-only test sources. Both are zero at DC.} 1370 340 0 0 0.23 0.23 {}
...
N 200 180 250 180 {lab=lg_main_e}
N 200 220 250 220 {lab=lg_main_f}
N 200 260 250 260 {lab=lg_bias_e}
N 200 300 250 300 {lab=lg_bias_f}
...
set noaskquit
echo BANDGAP_SINGLE_RUNNER_V9_TB05_LOOP_STABILITY
shell python3 \"/foss/designs/chipalooza-bandgap/Jonah_Saunders_Bandgap/run_bandgap.py\" --deck \"/headless/.xschem/simulations/TB05_LOOP_STABILITY.spice\" --test TB05_LOOP_STABILITY
echo RUNNER_RETURNED_CHECK_REPORT_AND_ERRORS
.endc
"}
C {lab_pin.sym} 200 180 0 0 {name=port_lg_main_e lab=lg_main_e}
C {lab_pin.sym} 200 220 0 0 {name=port_lg_main_f lab=lg_main_f}
C {lab_pin.sym} 200 260 0 0 {name=port_lg_bias_e lab=lg_bias_e}
C {lab_pin.sym} 200 300 0 0 {name=port_lg_bias_f lab=lg_bias_f}
C {vsource.sym} 1080 240 0 0 {name=VLG_MAIN value="DC 0 AC 0"}
C {lab_pin.sym} 1080 210 0 0 {name=p_main_e lab=lg_main_e}
C {lab_pin.sym} 1080 270 0 0 {name=p_main_f lab=lg_main_f}
C {isource.sym} 1210 240 0 0 {name=ILG_MAIN value="DC 0 AC 0"}
C {gnd.sym} 1210 210 2 0 {name=g_main lab=GND}
C {lab_pin.sym} 1210 270 0 0 {name=i_main_e lab=lg_main_e}
C {vsource.sym} 1410 240 0 0 {name=VLG_BIAS value="DC 0 AC 0"}
C {lab_pin.sym} 1410 210 0 0 {name=p_bias_e lab=lg_bias_e}
C {lab_pin.sym} 1410 270 0 0 {name=p_bias_f lab=lg_bias_f}
