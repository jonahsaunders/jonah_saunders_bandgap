...
F {}
E {}
T {TB08_POWER_DEVICE_LIMITS: Supply current and MOS voltage screening} 220 50 0 0 0.5 0.5 {}
T {Settings and selected profile: bandgap_config.json. Each bench runs independently.} 220 90 0 0 0.27 0.27 {}
...
set noaskquit
echo BANDGAP_SINGLE_RUNNER_V9_TB08_POWER_DEVICE_LIMITS
shell python3 \"/foss/designs/chipalooza-bandgap/Jonah_Saunders_Bandgap/run_bandgap.py\" --deck \"/headless/.xschem/simulations/TB08_POWER_DEVICE_LIMITS.spice\" --test TB08_POWER_DEVICE_LIMITS
